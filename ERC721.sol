...
contract MyToken is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    uint minEtherRate=0.10 ether;
    uint maxSupply=1;

    constructor() ERC721("MyToken", "MTK") {}

    function safeMint(address to, string memory uri) public payable onlyOwner {
        require( totalSupply() <= maxSupply , 'cannot mint more than allowed');
        require(msg.value >= minEtherRate, 'You should send ether with minimum ');
